...
public:
    int minimumOperations(vector<int>& nums) {
        ...
        int even_max_freq = 0, even_max_element = 0, even_sec_max_freq = 0,
            even_sec_max_element = 0;
        ...
        for (int i = 0; i < n; i = i + 2) {
            ...
            } else if (even[nums[i]] <= even_max_freq &&
                       nums[i] != even_max_element &&
        ...
        int odd_max_freq = 0, odd_max_element = 0, odd_sec_max_freq = 0,
            odd_sec_max_element = 0;
        ...
        for (int i = 1; i < n; i = i + 2) {
            ...
            } else if (odd[nums[i]] <= odd_max_freq &&
                       nums[i] != odd_max_element &&
        ...
        if (even_max_element != odd_max_element) {
            ...
            return min(n - odd_max_freq - even_sec_max_freq,
                       n - even_max_freq - odd_sec_max_freq);
        }
        return 0;
    }
};